    ...
    p5j.keyPressed = function (e){
      ...
      if (e.key==='c'){
        ...
        if(p5j.arrarea.length>0){
          ...
          let exeurl = 'https://script.google.com/macros/s/AKfycbxLJsiiuX57nJE0CLGGkAv_XvceND8nSpcCI-iFU9VM6t-GeZA/exec';          
          let editurl = 'https://docs.google.com/spreadsheets/d/15ZiA5y79c0HrI4EMbzSZsKThif3BI8itpXaeN3XKXPU/edit#gid=0';
        ...
        let url = 'https://spreadsheets.google.com/feeds/list/15ZiA5y79c0HrI4EMbzSZsKThif3BI8itpXaeN3XKXPU/1/public/values?alt=json';
        console.log(url);
        p5j.httpGet(url, 'jsonp', false, function(response) {
